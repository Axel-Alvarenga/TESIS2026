                    ...
                    <div class="question">
                        ...
                        <div class="comentario-original" id="comentario_p3">
                            <label>
                                ...
                                <span id="texto_obligatorio_p3" style="display: none; color: #dc2626; font-size: 0.85em; font-weight: normal; margin-left: 8px;">
                                    (Este campo es OBLIGATORIO porque seleccionaste "Otro")
                                </span>
                            </label>
                            ...
                            <div class="mensaje-error-texto" style="display: none; color: #dc2626; font-size: 13px; margin-top: 5px;">
                                ⚠️ Este campo es obligatorio porque seleccionaste "Otro".
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="step-page" data-step="3">
                    ...
                    <div class="question">
                        ...
                        <div class="comentario-original" id="comentario_p4">
                            <label>
                                <strong>¿Quieres añadir algo sobre qué te atraería a un espacio nuevo?</strong>
                                <span id="requerido_p4" class="required-mark" style="display: none;">*</span>
                                <span id="texto_obligatorio_p4" style="display: none; color: #dc2626; font-size: 0.85em; font-weight: normal; margin-left: 8px;">
                                    (Este campo es OBLIGATORIO porque seleccionaste "Otro")
                                </span>
                            </label>
                ...
                <div class="step-page" data-step="4">
                    ...
                    <div class="question">
                        ...
                        <div class="comentario-original" id="comentario_p4b1">
                            <label>
                                <strong>¿Quieres añadir algo sobre tu situación principal actual?</strong>
                                <span id="requerido_p4b1" class="required-mark" style="display: none;">*</span>
                                <span id="texto_obligatorio_p4b1" style="display: none; color: #dc2626; font-size: 0.85em; font-weight: normal; margin-left: 8px;">
                                    (Este campo es OBLIGATORIO porque seleccionaste "Otro")
                                </span>
                            </label>
                    ...
                    <div class="question">
                        ...
                        <div class="comentario-original" id="comentario_p4b2">
                            <label>
                                ...
                                <span id="texto_obligatorio_p4b2" style="display: none; color: #dc2626; font-size: 0.85em; font-weight: normal; margin-left: 8px;">
                                    (Este campo es OBLIGATORIO porque seleccionaste "Otro")
                                </span>
                            </label>
                    ...
                    <div class="question">
                        ...
                        <div class="comentario-original" id="comentario_p4b3">
                            <label>
                                ...
                                <span id="texto_obligatorio_p4b3" style="display: none; color: #dc2626; font-size: 0.85em; font-weight: normal; margin-left: 8px;">
                                    (Este campo es OBLIGATORIO porque seleccionaste "Otro")
                                </span>
                            </label>
                ...
                <div class="step-page" data-step="7">
                    ...
                    <div class="question">
                        ...
                        <div class="comentario-original" id="comentario_p5">
                            <label>
                                <strong>¿Quieres añadir algo sobre tu espiritualidad o búsqueda de sentido?</strong>
                                <span id="requerido_p5" class="required-mark" style="display: none;">*</span>
                                <span id="texto_obligatorio_p5" style="display: none; color: #dc2626; font-size: 0.85em; font-weight: normal; margin-left: 8px;">
                                    (Este campo es OBLIGATORIO porque seleccionaste "Otro")
                                </span>
                            </label>
                    ...
                    <div class="question">
                        ...
                        <div class="comentario-original" id="comentario_p6">
                            <label>
                                ...
                                <span id="texto_obligatorio_p6" style="display: none; color: #dc2626; font-size: 0.85em; font-weight: normal; margin-left: 8px;">
                                    (Este campo es OBLIGATORIO porque seleccionaste "Otro")
                                </span>
                            </label>
                ...
                <div class="step-page" data-step="9">
                    ...
                    <div class="question">
                        ...
                        <div class="comentario-original" id="comentario_p7">
                            <label>
                                <strong>¿Quieres añadir algo sobre tu proyecto de vida a futuro?</strong>
                                <span id="requerido_p7" class="required-mark" style="display: none;">*</span>
                                <span id="texto_obligatorio_p7" style="display: none; color: #dc2626; font-size: 0.85em; font-weight: normal; margin-left: 8px;">
                                    (Este campo es OBLIGATORIO porque seleccionaste "Otro")
                                </span>
                            </label>
                    ...
                    <div class="question">
                        ...
                        <div class="comentario-original" id="comentario_p8">
                            <label>
                                ...
                                <span id="texto_obligatorio_p8" style="display: none; color: #dc2626; font-size: 0.85em; font-weight: normal; margin-left: 8px;">
                                    (Este campo es OBLIGATORIO porque seleccionaste "Otro")
                                </span>
                            </label>
                ...
                <div class="step-page" data-step="11">
                    ...
                    <div class="question">
                        ...
                        <div class="comentario-original" id="comentario_p9">
                            <label>
                                <strong>¿Quieres añadir algo sobre tu visión de la Iglesia?</strong>
                                <span id="requerido_p9" class="required-mark" style="display: none;">*</span>
                                <span id="texto_obligatorio_p9" style="display: none; color: #dc2626; font-size: 0.85em; font-weight: normal; margin-left: 8px;">
                                    (Este campo es OBLIGATORIO porque seleccionaste "Otro")
                                </span>
                            </label>
